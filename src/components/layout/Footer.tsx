...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-slate-50 text-slate-600 py-12 px-4 sm:px-6 lg:px-8 mt-auto border-t border-slate-200">
      <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-4 mt-2">
            <a href="#" className="text-slate-400 hover:text-primary transition-colors cursor-pointer" aria-label="Facebook">
              <Facebook className="h-5 w-5" />
            </a>
            <a href="#" className="text-slate-400 hover:text-primary transition-colors cursor-pointer" aria-label="Twitter">
              <Twitter className="h-5 w-5" />
            </a>
            <a href="#" className="text-slate-400 hover:text-primary transition-colors cursor-pointer" aria-label="Instagram">
        ...
        <div className="flex flex-col gap-3">
          <h3 className="font-semibold text-slate-900 text-base">Platform</h3>
        ...
        <div className="flex flex-col gap-3">
          <h3 className="font-semibold text-slate-900 text-base">Legal</h3>
      ...
      <div className="mx-auto max-w-7xl mt-12 pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-sm">
